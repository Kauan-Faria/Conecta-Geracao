...
exports.MVP_TOPICS_DATA = void 0;
exports.MVP_TOPICS_DATA = [
    {
        slug: 'fazer-pix',
    ...
    },
    {
        ...
        steps: [
            {
                order: 1,
                instruction: 'O Gov.br é o portal do governo. Alguns serviços pedem um código enviado ao seu celular ou e-mail.',
                checkpointQuestion: 'Você já usou algum site do governo no celular?',
                checkpointHints: ['sim', 'não'],
            },
            {
                order: 2,
                instruction: 'Quando pedirem o código, abra a mensagem no celular e digite os números no site oficial do governo.',
                checkpointQuestion: 'Você recebeu uma mensagem com números?',
                checkpointHints: ['sim', 'não', 'ainda não'],
            },
            {
                order: 3,
                instruction: 'Use apenas sites que terminam com gov.br. Não compartilhe o código com outras pessoas.',
            },
            {
                order: 4,
                instruction: 'Se tiver dúvida, peça ajuda a alguém de confiança presencialmente. Este app não acessa o Gov.br por você.',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        steps: [
            {
                order: 1,
                instruction: 'Desconfie de mensagens urgentes pedindo dinheiro, códigos ou cliques em links estranhos.',
                checkpointQuestion: 'Você recebeu uma mensagem assim recentemente?',
                checkpointHints: ['sim', 'não'],
            },
            {
                order: 2,
                instruction: 'Não clique em links de WhatsApp ou SMS de números desconhecidos. Ligue para o banco pelo número do cartão.',
                checkpointQuestion: 'Você conhece quem enviou a mensagem?',
                checkpointHints: ['sim', 'não', 'não sei'],
            },
            {
                order: 3,
                instruction: 'Bancos e lojas não pedem códigos por mensagem para "desbloquear" conta. Isso costuma ser golpe.',
            },
            {
                order: 4,
                instruction: 'Em dúvida, pare e peça ajuda a familiar ou à polícia. Não transfira dinheiro sob pressão.',
            },
        ],
    },
];
//# sourceMappingURL=mvp-topics.data.js.map