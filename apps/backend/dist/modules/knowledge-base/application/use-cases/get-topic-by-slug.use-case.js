...
exports.GetTopicBySlugUseCase = void 0;
...
let GetTopicBySlugUseCase = class GetTopicBySlugUseCase {
    constructor(repository) {
        this.repository = repository;
    }
    async execute(rawSlug) {
        try {
            const slug = topic_slug_vo_1.TopicSlug.create(rawSlug);
            const topic = await this.repository.findBySlug(slug);
            if (!topic) {
                return (0, result_1.err)(new domain_errors_1.TopicNotFoundError(rawSlug));
            }
            return (0, result_1.ok)(topic);
        }
        catch (error) {
...
exports.GetTopicBySlugUseCase = GetTopicBySlugUseCase;
exports.GetTopicBySlugUseCase = GetTopicBySlugUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(knowledge_topic_repository_1.KNOWLEDGE_TOPIC_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], GetTopicBySlugUseCase);
//# sourceMappingURL=get-topic-by-slug.use-case.js.map