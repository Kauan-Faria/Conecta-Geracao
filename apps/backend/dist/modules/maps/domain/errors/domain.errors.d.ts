export type DomainErrorCode = 'INVALID_GEO_POINT' | 'INVALID_POI_CATEGORY' | 'INVALID_SEARCH_RADIUS' | 'INVALID_PLACE_QUERY' | 'SAME_ORIGIN_DESTINATION' | 'PLACE_NOT_FOUND' | 'ROUTE_NOT_FOUND' | 'EXTERNAL_SERVICE_UNAVAILABLE' | 'OVERPASS_TIMEOUT' | 'PROVIDER_TIMEOUT';
...
export declare class OverpassTimeoutError extends DomainError {
    constructor();
}
